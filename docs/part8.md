...
- Drink water consistently throughout the day, not just when singing
- "Pee pale" is the classic singer's hydration test — if your urine is dark, you're under-hydrated
- It takes hours for hydration to reach the voice, so hydrate the day before a performance, not just before
- Steam inhalation can provide more direct moisture to the vocal tract — useful before performances or in dry environments

**Things that dehydrate the voice:**
- Caffeine (mildly diuretic)
- Alcohol (significantly drying)
...
- Morning hoarseness that improves through the day
- Frequent throat clearing
- Sensation of mucus in the throat
- Voice cracking or instability for unclear reasons
- Chronic sore throat without illness

If you suspect reflux, see a laryngologist or a gastroenterologist. Treatment can be diet-based (avoiding triggers — coffee, citrus, spicy food, eating late, alcohol), positional (not lying down for 2–3 hours after eating), or medical (acid-reducing medications).
...
- Postnasal drip (irritates vocal folds)
- General inflammation in the upper airway
...
**Tired voice (push through with caution, or rest briefly):**
- Mild fatigue after a long practice
- Slight scratchiness from talking too much
- Reduced range that recovers within a day
- Resolves with rest, hydration, and sleep

**Damaged voice (stop and rest, possibly see a doctor):**
- Hoarseness lasting more than a few days
- Pain when singing or speaking
- Sudden dramatic loss of range
- Voice cutting out
- Blood in saliva (extreme — go to a doctor immediately)
...
- Warm up 30–45 minutes beforehand, with the bulk of warm-up an hour or so before the show, then a brief re-warm-up just before going on
- Stay hydrated throughout
- Avoid heavy meals immediately before (digestion competes with breath capacity)
- Avoid alcohol before and during (drying, plus impaired technique)
...
Don't tough out vocal problems. The earlier issues are caught, the easier they are to address.
